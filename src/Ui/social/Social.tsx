            ...
            <div className="hOvuuP">
                <ul className='dVLQAC'>
                    <motion.li variants={variant1} initial="hidden" animate="visible" className='github'>
                        <a href="http://github.com/Fisayomiii" aria-label="GitHub" target="_blank" rel="noreferrer">
                            <i className='bx bxl-github' ></i>
                        </a>
                    </motion.li>
                    <motion.li variants={variant2} initial="hidden" animate="visible" className='twitter'>
                        <a href="http://twitter.com/999tweets_her" aria-label="Twitter" target="_blank" rel="noreferrer">
                            <i className='bx bxl-twitter'></i>
                        </a>
                    </motion.li>
                    <motion.li variants={variant3} initial="hidden" animate="visible" className='linkedin'>
                        <a href="http://www.linkedin.com/in/fisayomiii" aria-label="Linkedin" target="_blank" rel="noreferrer">
                            <i className='bx bxl-linkedin'></i>
                        </a>
                    </motion.li>
                    <motion.li variants={variant4} initial="hidden" animate="visible" className='figma'>
                        <a href="http://dev.to/fisayomi" aria-label="Dev.to" target="_blank" rel="noreferrer">
